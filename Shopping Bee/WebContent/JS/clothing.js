...
var productInfo = {
	"clothing1" : {
		"Product_Name": "Clothing Item 1",
		"img" : "images/Dress-Suits-For-Men-Shining-470x470.jpg",
		"Brand" : "Brand1",
		"Price" : 20000,
...
$(document).ready(function(){
	...
	$('.catalog-items').click(function(){
		...
		console.log(item);
		localStorage.setItem('clothing_category', JSON.stringify(productInfo[item]));
		window.location.href ="clothing_description.jsp";
