...
var productInfo = {
	"sportsproduct1" : {
		"Product_Name": "Sports Item 1",
		"img" : "images/shutterstock_178624334.jpg",
		"Brand" : "Brand1",
		"Price" : 20000,
...
$(document).ready(function(){
	...
	$('.catalog-items').click(function(){
		...
		console.log(item);
		localStorage.setItem('sportsproducts_category', JSON.stringify(productInfo[item]));
		window.location.href ="sports_description.jsp";
