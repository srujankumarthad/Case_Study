...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top background" >
	  <div class="container">
	    ...
	    <div class="collapse navbar-collapse" id="myNavbar">
	        ...
	        <li><a href="home.jsp" class="navmenu active">Home</a></li>
	...
	<div class="container">
		<div class="welcome">
		<h1 class="text-center" style="font-family: 'Tangerine', serif !important; font-size: 4em; font-weight:bold;"> Welcome to Shopping Bee</h1>
		</div>
	</div>
