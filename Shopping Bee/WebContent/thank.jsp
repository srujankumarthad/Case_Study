...
<body>
	...
	<div class="container">
		<div class="welcome">
		<h1 class="text-center" style="font-family: 'Tangerine', serif !important; font-size: 4em; font-weight:bold; color:white !important"> Thank you for Shopping with Us</h1>
		</div>
	</div>
