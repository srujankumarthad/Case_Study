<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page import="com.shoppingbee.objects.Book" %>
...
<body>
	...
	<div class="container">
		<div class="row" style="margin-bottom: 5%;">
			...
			<% HttpSession productSession = request.getSession(false);%>
			<%Book book = (Book)productSession.getAttribute("product_info");%>
			<button type="button" class="btn btn-primary "id="shoppingback" style="margin-top: 5%;"> <<-- Back to Shopping </button>
			<div><img src="<%out.println(book.getImage());%>" class="img-thumbnail" id="product-image" style="width: 60%; height:auto; margin-top:5%"  alt="Product Image"></div>
			</div>
			<div class="col-xs-12 col-md-6" style="margin-top: 5%;" id="description_div">
			<h1 style="font-family: Tangerine, serif !important; font-size: 4em; font-weight:bold;"><%out.println(book.getProductName());%></h1><hr>
			<div id="star"> Rating :
			...
			<span style="float:right;">Price : &#8377; <%out.println(book.getPrice());%>/-</span>
			</div><hr>
			<div style="margin-bottom: 5%"><span style="font-size: 1.2em; font-weight:bold;"> Publisher: </span><span><%out.println(book.getPublisher());%></span></div>
			<div><h4>More Details:</h4><hr><div ><%out.println(book.getDetails());%></div><hr></div>
			<div><button type="button" class="btn btn-success" id="addcart"> Add to Cart </button></div>
...
<script type="text/javascript" src="JS/book_description.js"></script>
</body>
</html>